...
docs_scrape_tool = ScrapeWebsiteTool(
    website_url="https://github.com/stacksgov/residence-program"
)
                         
@CrewBase
class StacksAutomationExperiment1Crew():
    """StacksAutomationExperiment1 crew """
    ...
    @crew
    def crew(self) -> Crew:
        """Creates the new StacksAutomationExperiment1Crew"""
        return Crew(
            agents = self.agents,
            tasks = self.tasks,
